...
import { specializations, healthcareCategories } from "@/lib/constant";
...
const ProfilePage = ({ userType }: ProfileProps) => {
  ...
  const handleCategoryDelete = (indexToDelete: any): void => {
  ...
  const removeTimeRange = (index: number) => {
    setFormData((prev: any) => ({
      ...prev,
      dailyTimeRange: prev.dailyTimeRange.filter(
  ...
  const sidebarItems =
    userType === "doctor"
      ...
      : [
          ...
          { id: "medical", label: "Medical History", icon: MapPin },
