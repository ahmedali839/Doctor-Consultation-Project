          ...
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
            <div className='lg:col-span-4'>
              <div className='flex items-center space-x-2 mb-8'>
                <div className='w-18 h-10 bg-linear-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center'>
                  <Stethoscope className='text-white w-6 h-6' />
                </div>
                <div className='text-3xl font-bold flex bg-linear-to-br from-white to-blue-100 bg-clip-text text-transparent'>
                  Medicare +
                </div>
              </div>

              <p className='text-blue-100 mb-6 text-lg loading-relaxed'>
        ...
        <div className='py-8 border-t border-blue-700/50'>
          <div className='flex flex-col md:flex-row items-center justify-between gap-6'>
            <div>
              ...
              <p className='text-blue-200 text-sm'>Get health tips and product updated delivered to your inbox.</p>
            </div>
            ...
            <div className='flex flex-col sm:flex-row gap-3 w-full md:w-auto'>
              <input
                ...
                className='px-4 py-2 rounded-lg bg-blue-800/50 border border-blue-600 text-white placeholder:blue-300 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-transparent min-w-[200px]' />
              ...
              <div className='flex space-x-3'>
                {socials.map(({ name, icon: Icon, url }) => (
                  <a
                    ...
                    className='w-8 h-8 bg-blue700/50 hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors duration-200'
