    ...
    <section className='py-20 px-4 bg-linear-to-b from-blue-50 to-white'>
      ...
      <div className='container mx-auto text-center'>
        ...
        <div className='flex flex-col sm:flex-row gap-4 justify-center mb-12'>
          <Button onClick={handleBookConsultation} size='lg' className='bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-full px-8 py-3 text-lg'>
            Book a video visit
          </Button>
