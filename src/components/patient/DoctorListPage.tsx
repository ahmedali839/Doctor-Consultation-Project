          ...
          <div className="flex items-center justify-between mb-6">
            <div className="">
              ...
              <p className="text-gray-600 mt-1">
                Find the perfect healthcare provider for your health
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex overflow-x-auto gap-3 pb-2 scrollbar-hide">
              <Button
                ...
                className="shrink-0 flex rounded-full"
                onClick={() => handleFilterChange("category", "")}
              >
                All Categories
              </Button>

              {healthcareCategories.map((categories) => (
                <Button
                  key={categories.id}
                  variant={
                    filters.category === categories.title
                      ? "default"
                      : "outline"
                  }
                  className="flex shrink-0 rounded-full whitespace-nowrap"
                  onClick={() =>
                    handleFilterChange("category", categories.title)
                  }
                >
                  <div
                    className={`w-6 h-6 ${categories.color} rounded-2xl items-center justify-center flex group-hover:shadow-xl transition-all duration-200`}
                  >
                    <svg
          ...
          {showFilters && (
            <Card className="p-4 mb-4 bg-gray-50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  <label className="text-sm font-medium block mb-2" htmlFor="">
                    Specializations
                  </label>
                  <Select
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="fees">Consultant Fee</SelectItem>
                ...
                <CardContent className="p-6 flex flex-col h-full">
                  <div className="text-center mb-4">
                    ...
                    <div className="flex items-center justify-center space-x-1 mb-3">
                      <div className="flex">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <Star className="w-5 h-4 fill-orange-400 text-orange-400"></Star>
                        ))}
                      </div>
                  ...
                  <div className="flex flex-wrap gap-1 justify-center mb-4">
                    {doc.category?.slice(0, 2).map((category, idx) => (
                      <Badge
                        key={idx}
                        variant={"secondary"}
                    ...
                    <Badge
                      variant={"secondary"}
                      className="bg-yellow-50 text-yellow-700 border border-yellow-200 text-xs"
                    >
                  ...
                  <div className="mb-4 text-center space-y-2">
                    <div className="flex justify-center items-center text-gray-600">
                      ...
                      <span className="text-sm">{doc.hospitalInfo.city}</span>
                    </div>
